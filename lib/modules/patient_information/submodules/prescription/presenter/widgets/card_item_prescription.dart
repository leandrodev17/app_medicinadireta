...
class CardItemPrescription extends StatelessWidget {
  final PrescriptionController controller;
  final PrescriptionModel model;
  final int itemIndex;
  final ParamsToNavigationPage paramsToNavigationPage;
  const CardItemPrescription({Key? key, required this.controller, required this.model, required this.itemIndex, required this.paramsToNavigationPage}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String dataLocal = privacidadeClinica ? "privateClinical".tr : controller.dateFormatAllergy(model.dataLocal);
    ...
    String tipoDescricao = model.tipoDescricao ?? 'no_value'.tr;
    String versao = model.versao ?? 'no_value'.tr;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Flexible(child: ItemText(title: 'TIPO', description: tipoDescricao)),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10.hEx),
                            ItemText(title: 'Criação', description: versao),
                            SizedBox(height: 10.hEx),
                            Text('receituário'.toUpperCase(), style: TextStyle(color: ConstColors.cinza2, fontSize: 10.spEx, fontWeight: FontWeight.w400)),
