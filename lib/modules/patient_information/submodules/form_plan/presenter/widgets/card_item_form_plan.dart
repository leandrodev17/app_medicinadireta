...
class CardItemFormPlan extends StatelessWidget {
  final FormPlanController controller;
  final FormPlanModel model;
  final int itemIndex;
  final ParamsToNavigationPage paramsToNavigationPage;
  const CardItemFormPlan({Key? key, required this.controller, required this.model, required this.itemIndex, required this.paramsToNavigationPage}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String tipo = model.tipoDescricao?.toString() ?? 'no_value'.tr;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Flexible(child: ItemText(title: 'TIPO', description: tipo)),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10.hEx),
                            Text('formulário'.toUpperCase(), style: TextStyle(color: ConstColors.cinza2, fontSize: 10.spEx, fontWeight: FontWeight.w400)),
