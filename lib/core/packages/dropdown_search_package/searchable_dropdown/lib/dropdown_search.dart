...
import 'src/properties/properties.dart';
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  InputDecoration _manageDropdownDecoration(FormFieldState state) {
    ...
    //   hintStyle: TextStyle(color: Color(0xFF8F92B7), fontSize: 16, fontWeight: FontWeight.w400),
    //   errorStyle: TextStyle(color: Color(0xFFE64C2D), fontSize: 14, fontWeight: FontWeight.w500),
    //   labelStyle: TextStyle(fontWeight: FontWeight.w600, fontSize: 20, color: state.hasError ? Color(0xFF312F4F) : Color(0xFF0C29D0)),
    //   contentPadding: EdgeInsets.symmetric(vertical: 10, horizontal: 10),
    // );
    return (widget.dropdownSearchDecoration ?? InputDecoration(contentPadding: EdgeInsets.fromLTRB(12, 12, 0, 0), border: OutlineInputBorder()))
